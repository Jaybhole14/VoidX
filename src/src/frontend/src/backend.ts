...
export class Backend implements backendInterface {
    ...
    async getGuardianContact(): Promise<GuardianContact> {
        if (this.processError) {
            try {
                const result = await this.actor.getGuardianContact();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPanicLog(): Promise<Array<PanicLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPanicLog();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async logPanicActivation(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logPanicActivation();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveGuardianContact(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveGuardianContact(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
